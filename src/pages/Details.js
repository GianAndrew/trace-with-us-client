...
import { getVisitHistoryById } from '../features/visitHistory/historySlice';
...
const Details = () => {
	...
	useEffect(() => {
		dispatch(getVisitHistoryById(id));
	}, [dispatch, id]);
							...
							<div className='border-t border-gray-200'>
								<div>
									<div className='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
										...
										<dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:cols-span-2'>{data.visitors_id}</dd>
									</div>
									<div className='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
										<dt className='text-sm font-medium text-gray-500'>Establishment Code</dt>
										<dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:cols-span-2'>{data.establishment_code}</dd>
									</div>
									<div className='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
										<dt className='text-sm font-medium text-gray-500'>Name of Establishment</dt>
										<dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:cols-span-2'>{data.name_store}</dd>
									</div>
									<div className='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
