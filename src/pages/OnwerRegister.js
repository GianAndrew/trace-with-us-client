			...
			<section className='flex flex-col md:flex-row items-center min-h-screen'>
				<div className='bg-white lg:border w-full md:max-w-md lg:max-w-full md:mx-auto lg:mx-0 md:w-1/2 xl:w-2/3 h-screen px-10 md:px-4 lg:px-10 xl:px-12 flex items-center justify-center'>
					...
					<div className='h-full w-full flex items-stretch justify-center flex-col'>
						<p className='text-gray-500 font-semibold text-md'>OWNERS</p>
						...
						<div className='flex flex-col gap-2 mt-5'>
							...
							<div className='flex flex-col-reverse md:flex-row gap-2 mt-3'>
								{step <= 0 && (
									<button
										className='block w-full bg-blue-200 text-blue-500 hover:bg-blue-500 hover:text-white px-4 py-2 rounded-md text-md font-semibold shadow-md shadow-blue-200/75'
								...
								{step === 1 && (
									<>
										<button
											className='block flex-1 w-full bg-gray-200 text-gray-500 hover:bg-gray-500 hover:text-white px-4 py-2 rounded-md text-md font-semibold shadow-md shadow-gray-200/75'
											onClick={() => setStep(step - 1)}
										>
											Back
										</button>
										<button
											className='block flex-1 w-full bg-blue-200 text-blue-500 hover:bg-blue-500 hover:text-white px-4 py-2 rounded-md text-md font-semibold shadow-md shadow-blue-200/75'
											onClick={() => setStep(step + 1)}
										>
											Next
										</button>
								...
								{step === 2 && (
									<>
										...
										<button
											className='block flex-1 w-full bg-emerald-200 text-emerald-500 hover:bg-emerald-500 hover:text-white px-4 py-2  rounded-md text-md font-semibold shadow-md shadow-emerald-200/75'
